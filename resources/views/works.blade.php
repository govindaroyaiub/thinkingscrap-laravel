    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 antialiased">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <a href="/works/add-new" class="float-right mx-4 mt-4 my-4">
                    ...
                    <table id="myTable" class="table-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Client_id" style="text-align: center;">{{ Helper::getClientName($row->client_id) }}</td>
                                <td data-label="Summary">{{ $row->summary }}</td>
                                <td data-label="Action">
                                    <div class="flex justify-center">
                                        <a href="">
                                            <button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">View</button>
                                        </a>     
